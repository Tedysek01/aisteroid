...
import { Mail, Send, CheckCircle, AlertCircle, Phone, Instagram, Facebook, MessageCircle } from "lucide-react";
...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative px-6 py-24">
        <div className="text-center mb-16">
          ...
          <motion.h1
            ...
            className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400"
          >
            Kontaktujte nás
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="relative bg-[#1A1A1A] backdrop-blur-lg rounded-2xl p-8 border border-pink-500/10 overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400">
                  Kontaktní informace
                </h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-pink-200 mb-1">E-mail</h3>
                      <a href="mailto:tadeas@raska.eu" className="text-pink-200/70 hover:text-pink-200 transition-colors duration-300">
                        tadeas@raska.eu
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-pink-200 mb-1">Telefon</h3>
                      <a href="tel:+420608404401" className="text-pink-200/70 hover:text-pink-200 transition-colors duration-300">
                        +420 608 404 401
                      </a>
                    </div>
                  </div>
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl bg-[#242424] border border-pink-500/20 hover:border-pink-500/40 transition-all duration-300 group"
                  >
                    <Instagram className="w-5 h-5 text-pink-400" />
                    <span className="text-pink-200/70 group-hover:text-pink-200 transition-colors duration-300">Instagram</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-pink-200/70 group-hover:text-pink-200 transition-colors duration-300">Facebook</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-pink-200/70 group-hover:text-pink-200 transition-colors duration-300">Telegram</span>
                  </a>
                </div>
              </div>
            </div>
